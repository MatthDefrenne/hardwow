...
bool LootStoreItem::Roll(bool rate, float moreChance) const
{
    if (chance >= 100.0f)
        return true;
...
void LootTemplate::Process(Loot& loot, bool rate, uint16 lootMode, uint8 groupId, Player* player) const
{
